---
title: Objects
info: Learn how to manage objects in Twenty.
icon: IconChecklist
...
Objects are the data entities that represent components of the business, such as customers, sales, products, and interactions, providing means to manage and analyze customer relationships.

# Standard Objects

Your workspace comes pre-equipped with standard objects. They're predefined entities that offer integrated, standardized intelligence without needing any extra configuration.
...
The `Companies` object consolidates business account information. It encompasses all pertinent data such as industry, size, location, and contact personnel, thereby offering an integrated perspective of your business's organizational connections. It's both link to the People and Opportunities objects.
