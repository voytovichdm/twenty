...
Webhooks allow for immediate updates to your specified URL regarding changes or events related to your customer data.

For instance, a webhook can alert your system in real-time when a new person record is created or an existing note is updated.
