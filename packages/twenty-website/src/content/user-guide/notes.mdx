---
title: Notes
info: Learn how to create, comment, format, and delete notes in our system.
icon: IconNote
---

<img src="/images/user-guide/notes_header.png" style={{width:'100%', maxWidth:'800px'}}/>

Manage your record-linked notes efficiently using our powerful **Notes** feature. This guide walks through how to create, format, comment, and delete notes seamlessly within record pages. 

# Creating Notes

Creating notes in our system is intuitive and dynamic. You can either:
...
All your notes linked to a specific record are displayed on the corresponding `Record page` under the Notes section.

# Commenting
**Comments**: Collaborate effectively with your team members by adding comments on notes for updates, feedback, or discussions.
...
Please be aware that once a note is deleted, the action is permanent and it cannot be undone.
